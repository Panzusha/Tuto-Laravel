<!-- utilisation de l'opérateur ternaire de layout.php pour avoir le nom de l'article en onglet navigateur -->
<x-default-layout :title="$post->title">
    <div class="space-y-10 md:space-y-16">
        {{-- booléen sans la liste (voir post.blade.php) --}}
        <x-post :$post />
        {{-- Seuls les utilisateurs authentifiés peuvent créer un commentaire donc @auth --}}
        @auth
        <form action="{{ route('posts.comment', ['post' => $post]) }}" method="POST"> 
            ...
            <div class="flex h-12">
                ...
                focus:outline-indigo-500" type="text" name="comment" placeholder="Ecrivez un commentaire 🎉" 
                autocomplete="off">
